...
public final class QueryUtils_ResearchResult_google {
    private static final String LOG_TAG = QueryUtils_ResearchResult_google.class.getSimpleName();
    private QueryUtils_ResearchResult_google(){ }

    public static List<SearchParameter_Google> fetchBusInfo(String requestUrl){
        ...
        List<SearchParameter_Google> BusInfos = extractFeatureFormJson(jsonResponse);
        return  BusInfos;
    }
    ...
    private static List<SearchParameter_Google> extractFeatureFormJson (String jsonResponse){
...
//
//                SearchParameter_directly searchParameter_directly = new SearchParameter_directly(getEstimateTime,
//                        getLen_end, getlen_start,getNumber, getRouteId, getFrom, getTo ,getEndLatitude,
//                        getEndlongitude,getEndNameZh, getEndStopLocationId, getStartLatitude,getStartLongitude,
//                        getStartNameZh, getStopLocationIs);
//
...
//            searchParameter = new SearchParameter(directlyList, GoogleList );
